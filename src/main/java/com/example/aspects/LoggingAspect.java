...
public class LoggingAspect {
    ...
    @Before("execution(void com.example..*.set*(*))") // Point-cut/Point-cut language
    // callSetters defines the advice
    public void callSetters(JoinPoint joinPoint) { // Joint-point - the counter part/target
